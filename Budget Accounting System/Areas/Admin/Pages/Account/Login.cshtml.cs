...
namespace Budget_Accounting_System.Areas.Admin.Pages.Account;
...
public class LoginModel : PageModel
{
    ...
    public void OnGet(string? returnUrl = null)
    {
        ...
        ReturnUrl = returnUrl ?? Url.Page("/Dashboard", new { area = "Admin" });
    }

    public async Task<IActionResult> OnPostAsync(string? returnUrl = null)
    {
        returnUrl ??= Url.Page("/Dashboard", new { area = "Admin" });
        ...
        if (ModelState.IsValid)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("Admin user {LoginId} logged in.", Input.LoginId);
