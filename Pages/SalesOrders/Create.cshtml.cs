...
public class CreateModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync(string action)
    {
        ...
        try
        {
            ...
            TempData["SuccessMessage"] = $"Sales Order {salesOrder.SONumber} {(action == "confirm" ? "confirmed" : "created")} successfully!";
    ...
    private async Task LoadDropdownsAsync()
    {
        Customers = await _context.Contacts
            .Where(c => c.IsActive && (c.Type == ContactType.Customer || c.Type == ContactType.Both))
            .OrderBy(c => c.Name)
            .ToListAsync();
